    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          { label: 'Depenses mois', value: formatMontant(stats.depensesMois ?? 0), icon: BarChart3, color: 'text-red-600', bg: 'bg-red-50' },
          { label: 'Benefice net', value: formatMontant(stats.beneficeNet ?? 0), icon: TrendingUp, color: (stats.beneficeNet ?? 0) >= 0 ? 'text-green-600' : 'text-red-600', bg: (stats.beneficeNet ?? 0) >= 0 ? 'bg-green-50' : 'bg-red-50' },
